...
### This shows the data from the most recent data collection date: 02-11-2021.
```{r}
covid %>% 
...
covid %>% 
  ...
  arrange(desc(cumulative_cases))
```
<font size="3" color="blue">The countries with the highest cumulative deaths are: the United States, India, Brazil, the Russian Federation, and the United Kingdom.</font>
